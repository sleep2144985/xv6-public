...
ls(char *path)
{
 ...
 11c:	0f 88 9e 01 00 00    	js     2c0 <ls+0x1c0>
  ...
  if(fstat(fd, &st) < 0){
 122:	8d b5 cc fd ff ff    	lea    -0x234(%ebp),%esi
 ...
 139:	0f 88 c1 01 00 00    	js     300 <ls+0x200>
  ...
  switch(st.type){
 13f:	0f b7 85 cc fd ff ff 	movzwl -0x234(%ebp),%eax
 ...
 155:	8b 95 dc fd ff ff    	mov    -0x224(%ebp),%edx
 15b:	8b b5 d4 fd ff ff    	mov    -0x22c(%ebp),%esi
 161:	57                   	push   %edi
 ...
 1c3:	57                   	push   %edi
 1c4:	8d bd bc fd ff ff    	lea    -0x244(%ebp),%edi
 1ca:	50                   	push   %eax
 ...
 212:	0f 85 71 ff ff ff    	jne    189 <ls+0x89>
      if(de.inum == 0)
 218:	66 83 bd bc fd ff ff 	cmpw   $0x0,-0x244(%ebp)
 21f:	00 
 220:	74 de                	je     200 <ls+0x100>
        continue;
      memmove(p, de.name, DIRSIZ);
 222:	8d 85 be fd ff ff    	lea    -0x242(%ebp),%eax
 ...
 257:	0f 88 c3 00 00 00    	js     320 <ls+0x220>
      ...
      printf(1, "%s %d %d %d\n", fmtname(buf), st.type, st.ino, st.size);
 25d:	8b 8d dc fd ff ff    	mov    -0x224(%ebp),%ecx
 263:	0f bf 85 cc fd ff ff 	movswl -0x234(%ebp),%eax
 26a:	83 ec 0c             	sub    $0xc,%esp
 26d:	8b 95 d4 fd ff ff    	mov    -0x22c(%ebp),%edx
