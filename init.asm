...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41f:	f7 f6                	div    %esi
 421:	0f b6 92 00 08 00 00 	movzbl 0x800(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 598:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 59b:	b8 f6 07 00 00       	mov    $0x7f6,%eax
...
free(void *ap)
{
 ...
 677:	89 08                	mov    %ecx,(%eax)
  freep = p;
 679:	a3 a4 0a 00 00       	mov    %eax,0xaa4
}
 67e:	5b                   	pop    %ebx
 67f:	5e                   	pop    %esi
 680:	5f                   	pop    %edi
 ...
 69a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 69d:	a3 a4 0a 00 00       	mov    %eax,0xaa4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 75f:	89 15 a4 0a 00 00    	mov    %edx,0xaa4
      return (void*)(p + 1);
 ...
 774:	eb e9                	jmp    75f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 776:	c7 05 a4 0a 00 00 a8 	movl   $0xaa8,0xaa4
 77d:	0a 00 00 
 780:	c7 05 a8 0a 00 00 a8 	movl   $0xaa8,0xaa8
 787:	0a 00 00 
    base.s.size = 0;
 78a:	b8 a8 0a 00 00       	mov    $0xaa8,%eax
